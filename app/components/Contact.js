    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="mr-20 mx-auto text-left flex flex-col justify-center align-center ">
          ...
          <p className="text-white flex align-center border-b py-5 w-1/2 text-[14px] contact-text"><FaLinkedinIn  size={24} color="#0072ff"/><a href="https://www.linkedin.com/in/pallavi-bobde-35ba721b2" className="ml-5 ">https://www.linkedin.com/in/pallavi-bobde-35ba721b2</a></p>
          <p className="text-white flex align-center py-5 w-1/2 text-[14px] contact-text"><FaGithub  size={24} color="#0072ff" /> <a href="https://github.com/PallaviBobde" className="ml-5 ">https://github.com/PallaviBobde</a></p>
